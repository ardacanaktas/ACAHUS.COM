...
<link href="https://fonts.googleapis.com/css2?family=Anton&family=Russo+One&family=Space+Grotesk:wght@300..700&family=Teko:wght@505&display=swap" rel="stylesheet">
    ...
    <body>
        <div id="hero">
            <img src="img/atmosphere-sky-cloud-atmospheric-phenomenon-astronomical-object-horizon-2075165-wallhere.com.jpg" width="1600px"height="730px">
            <div class="content">
                <div class="geridön">
                            ...
                            <div class="inneer">
                                <div class="slidee slidee_2">
                                    <div class="slidee-contentt">
                                        <img src="img/kaan.png" alt="" width="800px" height="500px">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="comtainer">
    ...
    <div class="comtainerbaş">KAAN</div>
        <p>Türk Hava Kuvvetleri Komutanlığımızın envanterinden 2030’lu yıllardan itibaren kademeli olarak devreden çıkartılması düşünülen F-16 uçaklarının yerini alabilecek, yurt içi imkân ve kabiliyetler ile tasarlanan ve geliştirilen bir savaş uçağının üretilmesi ve bu uçağı tasarlayıp geliştirebilecek insan gücü ve altyapının oluşturulması amacıyla başlatılan KAAN Geliştirilmesi Projesi’nde şirketimiz ana yüklenici konumundadır.
